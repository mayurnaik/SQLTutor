	...
	public static Collection<Object[]> parameters() {
		Object[][] params = {
			...
			{"SELECT * FROM employee WHERE (salary BETWEEN 30000 AND 40000) AND department_id = 5", 
				...
				Pattern.quote("Select all attributes of each employee where the employee's salary is between $30,000 and $40,000 and department id is 5.")},
			...
			{"SELECT e.first_name, e.last_name, e.address FROM employee e, department d WHERE d.name = 'Research' AND d.id = e.department_id", 
				...
				Pattern.quote("Select the first name, last name, and address of each employee where the employee works for the Research department.")},
			...
			{"SELECT birthdate, address FROM employee WHERE first_name = 'John' AND middle_initial = 'B' AND last_name = 'Smith'", 
				...
				Pattern.quote("Select the birth date and address of each employee where the employee's first name is \"John\", "
						+ "the employee's middle initial is \"B\", and the employee's last name is \"Smith\".")},
			...
			{"SELECT E.last_name AS employee_name, S.last_name AS supervisor_name FROM employee AS E, employee AS S WHERE E.manager_ssn = S.ssn", 
				Pattern.quote("Select the last names of each employee and employee's supervisor.")},
